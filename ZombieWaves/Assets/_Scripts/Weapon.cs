...
public class Weapon : MonoBehaviour
{
    ...
    private void enterADS()
    {
        ...
        playerCamera.fieldOfView = Mathf.Lerp(playerCamera.fieldOfView, 40.0f, 3.5f * Time.deltaTime);
    }
    ...
    private void exitADS()
    {
        ...
        playerCamera.fieldOfView = Mathf.Lerp(playerCamera.fieldOfView, 60.0f, 3.5f * Time.deltaTime);
    }
